...
The [2025 Bootcamp](https://hds.uic.edu/news-and-events/2025-bootcamp-information/) organized by the Health Data Science Institute I co-direct was the second time such an event took place on the UIC campus, and it was an unmitigated success. 


# New JCO paper
_Aug 2, 2025_

Congratulations to Eric and Guadalupe for an excellent new paper on methodology for survival modeling based on patient-reported-outcomes: E. Anyimadu, Y. Wang, A. C. Moreno, C. D. Fuller, X. Zhang, G. E. Marai,  G. Canahuate, Evaluating Dimensionality Reduction for Patient-Reported Outcome-Based Survival Modeling in Head and Neck Cancer Patients, Journal of Clinical Oncology Aug. 2025.



# Welcome Khairi Reda and Saeed Boorboor!
_Aug 1, 2025_

So excited to welcome our new EVL colleagues Khairi Reda and Saeed Boorboor! Khairi is returning to UIC as an Associate Professor, and Saeed is joining us as an Assistant Professor. Welcome!

# VAHC'25 paper from Nafiul Nipu
_July 31, 2025_

Congratulations to Nafiul Nipu for  this new paper describing the lessons we learned a year after deploying an interactive risk predictor for head and neck cancer outcomes to the medical profession: N. Nipu, L. van Dijk, G. Canahuate, C.D. Fuller, G.E. Marai, Lessons from the Development and Deployment of an Interactive Oncological Risk Estimator, VAHC 2025 (16th workshop on Visual Analytics in Healthcare), in conjunction with IEEE VIS 2025, Vienna, Austria, pp. 1-7, November 2025. 



# Moving to the new CS building!
_July 23, 2025_

So happy to be relocating to the new CS building on campus. My new office is in CDRLC, 850 W Taylor St.

# EMBC presentation of new mHealth project
_July 18, 2025_

Thrilled to be presenting this new project from our group, which leverages consumer-grade mHealth technology to support investigating sarcopenia in head and neck cancer patients during radiation therapy treatment. The software platform, mEnergy, blends a Withings scale and a Fitbit smartwatch with SpO2 capabilities to monitor remotely in near real-time a subjects's body composition trends, sleep disturbances that could indicate apnea, and levels of physical activity which could indicate fatigue: N. Nipu, A. Wentzel, N. Heshmati Molaei, N. Sangi, X. Zhang, G. Canahuate, C. D. Fuller, G. E. Marai, mEnergy: Development of a Novel mHealth Multi-device Platform for Near Real-time Remote Assessment of Energy Disorders, pp.1-7, The 47th Annual International Conference of the IEEE Engineering in Medicine and Biology Society (EMBC) 2025 (podium presentation). 


# New VIS paper from Sanjana Srabanti
_July 16, 2025_

Congratulations to Sanjana on her new VIS paper: StreetWeave: A Declarative Grammar for Street-Overlaid Visualization of Multivariate Data,
Sanjana Srabanti, G. Elisabeta Marai, Fabio Miranda, IEEE Transactions on Visualization and Computer Graphics (To appear). The paper proposes a design space for street-overlaid visualizations, and a declarative grammar to operationalize such space.


# NSF CAREER Award to Assistant Professor Wei Tang!
_June 15, 2025_

Congratulations to my wonderful mentee Wei Tang for receiving a prestigious NSF CAREER award! This year the UIC CS department faculty have received a record of 3 NSF CAREER awards. 

# New projects from the Videogame Design course
_May 15, 2025_

A new set of terrific projects from the Videogame Design course I taught this Spring. CS426 is essentially a pretty tough software engineering/project management/game design course, where students learn not only about game design and implementation, but also about working together as a team. I'm always floored with the quality of the games our students produce by the end of the semester: [https://www.evl.uic.edu/cs426/gallery/index.html](https://www.evl.uic.edu/cs426/gallery/index.html).


# New EVL paper on Immersive Analytics
_March 5, 2025_

Luc Renambot will present this new EVL paper at the IEEE VR 2025 Workshop on Immersive Visualization Laboratories - Past, Present and Future:
L. Renambot, M. Papka, J. Talandis, M. Brown,  G.E. Marai, L. Long, F. Miranda, D. Tsoupikova, D. Plepys, N. Soni, Immersive Analytics at the Electronic Visualization Laboratory, IEEE VR 2025 Workshop on Immersive Visualization Laboratories - Past, Present and Future. 


# Terrific new multi-site paper predicting orodental toxicity after radiation therapy
_Jan 10, 2025_

Here's a new terrific paper with our MD Anderson collaborators, and an accompanying [interactive decision support tool](https://uic-evl.github.io/OsteoradionecrosisVis/) created by my group, describing a validated model for ORN risk stratification using multi-institutional cohorts: L. Humbert-Vidan, S. Kamel, A. Wentzel et al,  [Externally validated digital decision support tool for time-to-osteoradionecrosis risk-stratification using right-censored multi-institutional observational cohorts](https://www.sciencedirect.com/science/article/pii/S0167814025001859?dgcid=coauthor), Radiotherapy and Oncology, pp. 1-9, 207, Elsevier 2025.  


# Congratulations to Dr. Andrew Wentzel for a successful defense!
_Dec 10, 2024_

Heartfelt congratulations to Dr. Wentzel, who has successfully defended his doctoral dissertation titled [Visual Computing Design for Explainable, Spatially-aware Machine Learning](https://www.evl.uic.edu/pubs/2882). It's been such a joy to work with you, Andrew.


# New CGA paper reflecting on data visualization lessons from the pandemic
_Dec 5, 2024_

Excited to see this joint paper from the Dagstuhl pandemic visualization seminar accepted for publication by the IEEE Computer Graphics and Applications magazine: T. Baumgartl, M. Ghoniem, T. von Landesberger, G.E. Marai, S. Miksch, S. Scheithauer, N, Srivastava,
 Empowering Communities: Tailored Pandemic Data Visualization for Varied Tasks and Users, 
pp.1-8, IEEE Comp Graph. App, Jan 2025. 



# Health Data Science Institute seed awards announced
_Dec 2, 2024_

Extremely happy to announce the [three winning teams of seed awards](http://www.hds.uic.edu) from the Institute I co-direct with Andrew Boyd.


# Google Health meeting
_Nov 21, 2024_

Pleased to be part of the UIC working group meeting with the Google Health team.

# MD Anderson Cancer Center visit
_Nov 11, 2024_

Thrilled to be visiting in person, together with Guadalupe Canahuate, our collaborators at MD Anderson Cancer Center in Houston Texas, and to hold a seminar and a mentoring session.


# Serving on the UIC Senate Research Committee
_Nov 10, 2024_

Honored to represent the College of Engineering on the UIC Senate Research Committee.



# PRO-based stratification paper at BHI'24
_Nov 9, 2024_

Congratulations to our collaborators at University of Iowa and MD Anderson Cancer Center for a paper leveraging our work together to improve the toxicity risk stratification of head and neck cancer patients:
Anyimadu, E.A., Wang, Y., Floricel, C., Kamel, S., Moreno, A.C., Fuller, C.D., Zhang, X., Marai, G. and Canahuate, G.M., 
 [PRO-based Stratification Improves Model Prediction for Toxicity and Survival of Head and Neck Cancer Patients](https://mdanderson.elsevierpure.com/en/publications/pro-based-stratification-improves-model-prediction-for-toxicity-a), in IEEE-EMBS International Conference on Biomedical and Health Informatics, 2024. This paper was also selected for publication in the  IEEE Journal of Biomedical and Health Informatics 2024. 




# Medical digital twin work presented at IEEE VIS'24
_Oct 13, 2024_

Heartfelt congratulations to Andrew Wentzel and team for our paper on a digital twin for the head and neck cancer treatment decision process, which is presented this week at IEEE VIS'24: A. Wentzel, S. Attia, X. Zhang, G. Canahuate, C.D. Fuller, G.E. Marai,
[DITTO: A Visual Digital Twin for Interventions and Temporal Treatment Outcomes in Head and Neck Cancer](https://www.evl.uic.edu/pubs/2827), pp. 1-11, IEEE Trans. Vis. Comp. Graphics, Jan 2025 / VIS 2024. Sadly, the conference is virtual due to the hurricane impact on Tampa. 


# Spatial transcriptomics work presented at the BioVisMedChallenge 2024
_Oct 11, 2024_

Congratulations to Siyuan for his first paper as part of our lab, on spatial transcriptomics visualization, as part of the BioMedVis Challenge at IEEE VIS'23: S. Zhang, G.E. Marai, A Part-to-Whole Circular Cell Explorer,  IEEE BioMedVis Challenge, IEEE VIS, 2024.



# IEEE VIS 2025 Area Chair
_Sep 15, 2024_

Honored to co-chair the IEEE VIS'25 Applications Area together with Wes Willet. My advisees will not be able to submit to this area next year.


# Chartered NIH study section membership
_Sep 2, 2024_

Deeply honored to have been vetted and approved as a chartered member of the [NIH Clinical Informatics and Digital Health (CIDH) study section](https://public.era.nih.gov/pubroster/roster.era?CID=105251) for the next 4 years. 


# Excellent MS and PhD program admission yield
_Aug 30, 2024_

Happy to see, as the [CS Director of Graduate Admissions](https://cs.uic.edu/graduate/admissions/), the highest incoming MS and PhD cohort in several years.


# The Health Data Science Institute bootcamp is a success
_Aug 12, 2024_

The [2024 Bootcamp](https://hds.uic.edu/news-and-events/2024-bootcamp-information/) organized by the Health Data Science Institute I co-direct was the first time such an event took place on the UIC campus, and it was a great success. 


# BI-LAVA active learning for image labeling paper accepted by CGF
_Aug 10, 2024_

Incredibly pleased to see Juan's work accepted by the Computer Graphics Forum. Congratulations to the team, including our Peruvian summer intern Will Berrios! J. Trelles, A. Wentzel, W. Berrios, H. Shatkay, G.E. Marai
[BI-LAVA: Biocuration with Hierarchical Image Labeling through Active Learning and Visual Analytics](https://www.evl.uic.edu/pubs/2861)
pp.1-15, Comp. Graph. Forum 2024



# Patient Reported Outcomes paper presented at DEXA'24
_Aug 1, 2024_

Congratulations to our collaborators at University of Iowa and MD Anderson Cancer Center, and particularly to Eric and Guadalupe, for having this paper presented at DEXA'24: E. A. Anyimadu, C.D. Fuller, X. Zhang, G.E. Marai, G. Canahuate, 
Collaborative Filtering for the Imputation of Patient Reported Outcomes, 
35th Database and Expert Systems Applications Conference (DEXA 2024), Naples, Italy, Aug 2024.



# EVL history paper accepted by Presence
_Aug 1, 2024_

Such a joy to see this wonderful history (led by the great Maxine Brown) of the Electronic Visualization Laboratory published by Presence: Johnson, L. Renambot, G.E. Marai, D. Tsoupikova, M.E. Papka, L. Long, D. Plepys, J. Talandis, M.D. Brown*, J. Leigh, D.J. Sandin, T.A. DeFanti, 
[Electronic Visualization Laboratory?s 50th Anniversary Retrospective: Look to the Future, Build on the Past](https://www.evl.uic.edu/pubs/2873), pp. 1-51, Presence: Virtual and Augmented Reality, MIT Press 2024.

# Co-Chairing the Vis/SciVis Test of Time Awards Committee for VIS'24
_July 15, 2024_

Honored to co-chair with Edi Groller the Vis/SciVis Test of Time Awards committee for IEEE VIS'24.


# Serving on the DPI Executive Committee
_July 10, 2024_

I have been elected to serve as  a UIC representative on the [Discovery Partners Institute](https://dpi.uillinois.edu/) EC.


# Digital twin work featured in IEEE Computing Edge!
_July 1, 2024_

So proud to see Nafiul's pioneering work in [contrail digital twins](https://www.evl.uic.edu/events/2829) featured in the the [IEEE Computing Edge magazine](https://cs.uic.edu/news-stories/doctoral-student-featured-in-ieee-computing-edge/), which gets sent to all IEEE Computer Society members.



# Pandemic visualization paper accepted by CGF
_June 30, 2024_

Congrats to Andrew Wentzel and co-authors on having their pandemic visualization paper accepted by the Computer Graphics Forum journal: A. Wentzel, L. Levine, V. Dhariwal, Z. Fatemi, A.Bhattacharya, B. Di Eugenio,  A. Rojecki, E. Zheleva, G.E. Marai, 
 [MOTIV: Visual Exploration of Moral Framing in Social Media](https://www.evl.uic.edu/pubs/2803), pp. 1-14, 
...
Welcome to David Rios, Rayyan Rashid, and Yuseph Shilleh to EVL! This great undergraduate team will work with us and the College of Medicine specialists on cleaning up, transcribing, and analyzing lung cancer data.


# Serving on the Honors Council at UIC
_May 30, 2024_

Honored to serve on the UIC Honors College Council this year.


# Faculty Fellow of the Year, Honors College UIC
_May 15, 2024_

Humbled to receive the Faculty Fellow of the Year award from the UIC Honors College.


# Congrats to Farah Kamleh on her graduation with a BSMS degree!
_May 9, 2024_

Congratulations to [Farah Kamleh](https://www.evl.uic.edu/pubs/2816) for her BSMS in CS degree graduation as part of the UIC Honors College! It's been such a pleasure working with you.


# Congrats to Andrew Wentzel for College-level Research Award!
_May 2, 2024_

Congratulations and well-deserved to Andrew Wentzel for receiving the UIC College of Engineering Exceptional Research Promise Award this year!


# Congrats to the cs426 class!
_Apr 30, 2024_

Congratulations to this year's cs426 Videogame Design and Development class! It's been such a joy to be able to teach this class again after a few years off.


# Associate Editor for CGA
_Apr 3, 2024_

Honored to be appointed as an Associate Editor for IEEE Computer Graphics and Applications. Together with Jillian Aurisano at University of Cincinnati, we will also edit a [Special Issue on Bioinformatics Data Visualization](http://www.computer.org/digital-library/magazines/cg/cfp-biological-data-visualization). 


# Participating in the Dagstuhl Pandemic seminar
_Feb 24, 2024_

Happy to be in the Dagstuhl Pandemic Data Visualization seminar, and to meet such cool researchers across the disciplines.



# Director of the new UIC Institute for Health Data Science Research!
_Feb 15, 2024_

Honored to be a co-founder and appointed Director of the UIC [Institute for Health Data Science Research](http://hds.uic.edu) together with Andy Boyd and a great team of co-directors. An initiative of the Office of the Vice Chancellor for Research, the institute aims to bridge data science and computing research on campus with healthcare research at UIC.


# Kiviat Defense project images featured on the cover of Journal of Imaging Science and Technology
_Jan 10, 2024_

Kiviat Defense project images are featured on the cover of the Journal Imaging Science and Technology issue for Dec. 2023. Congratulations, Mirko and team!




# Paper from MS thesis presented at Electronic Imaging 2024
_Jan 7, 2024_

Andrew Wentzel is presenting at EI 2024 work stemming from Mirko Mantovani's MS thesis: M. Mantovani, A. Wentzel, J. Trelles, J. Michaelis, G.E. Marai
 [Kiviat Defense: An Empirical Evaluation of Visual Encoding Effectiveness in Multivariate Data Similarity Detection](https://www.evl.uic.edu/pubs/2792), 
Journal of Imaging Science and Technology, Jan 2024. The paper has also been published in the JIST journal, under the journal-first submission model.


# Welcome, Hossein!
_Jan 5, 2024_

Happy Hossein Fathollahian was able to join our group this semester. Hossein comes to us from Iran. Welcome!


# MouseScholar paper presented at BIBM'24
_Dec 10, 2023_

Congrats to Juan Trelles for presenting his work at the BIBM 2023 conference (19% acceptance rate)! Hagit, you are so missed. J. Trelles, C. Floricel, C. Arighi, H. Shatkay, D. Raciti, M. Ringwald, G.E. Marai,  
[MouseScholar: Evaluating an Image+Text Search System for Biocuration](https://www.evl.uic.edu/pubs/2766),
IEEE International Conference on Bioinformatics and Biomedicine (BIBM) 2023, December 2023, Istanbul, Turkey.



# At Dagstuhl BioVis Seminar
_Nov 23, 2023_

Happy to meet old friends and make new friends at the Dagstuhl BioVis seminar this year.


# At IEEE VIS'23 in Melbourne
_Oct 23, 2023_

Honored to be chairing the Best Papers session and to co-chair the Test of Time session at the conference. Also happy to see Andrew Wentzel's work on Pandemic Stay-At-Home Attitudes presented at the PandemicVis workshop, and Carla Floricel's work presented in the main conference.
...
Glad to see this work presented at the HPC Precision Medicine workshop at ISC 2023: S. Gawane, X. Zhang, G. Canahuate, A. Wentzel, A. Mohamed, L. van Dijk, C.D. Fuller, G.E. Marai,
Interpretable Transformer-based Meta-Reinforcement Learning for Longitudinal Head-and-Neck Cancer Treatment, Sixth ISC Workshop on HPC Applications in Precision Medicine, Oct 2023. Congratulations, Sarang, Xinhua, and team! 


# Paper accepted at the Vis4PandEmRes, colocated with IEEE VIS'23
_Sep 1, 2023_

Our paper describing the constrained design process we followed during the pandemic to enhance knowledge about the efficacy of Stay at Home orders in the US has been accepted by the Vis4PandEmRes workshop: A. Wentzel, L. Levine, V. Dhariwal, Z. Fatemi, A. Bhattacharya, B. Di Eugenio, A. Rojecki, E. Zheleva, G. E. Marai, [A Lens to Pandemic Stay at Home Attitudes](https://arxiv.org/abs/2308.13552),
IEEE VIS Workshop on Visualization for Pandemic and Emergency Responses 2023 (Vis4PandEmRes), Oct. 2023, Melbourne, Australia. Congratulations, Andrew and team!
...
The journal Bioinformatics Advances has accepted our paper:
J. Trelles Trabucco, C. Arighi, H. Shatkay, G. E. Marai, 
["Enhancing biomedical search interfaces with images"](https://academic.oup.com/bioinformaticsadvances/article/3/1/vbad095/7225231?utm_source=advanceaccess&utm_campaign=bioinformaticsadvances&utm_medium=email), 
Bioinformatics Advances, July 2023. This work presents CORD-19 IMAGE SCHOLAR: a publication retrieval system for the CORD-19 documents from the Allen Institute collection that contain both the desired text and desired image modalities (such as "cell" and "microscopy"), and which presents the document information along with the relevant images in those documents. 
See the system [here](https://runachay.evl.uic.edu/scholar). Congratulations, Juan and team, and we miss you so much, Hagit. 
...
IEEE VIS'23 has accepted our paper: 
C. Floricel, A. Wentzel, A. Mohamed, C.D. Fuller, G. Canahuate, G.E. Marai,
[Roses Have Thorns: Understanding the Downside of Oncological Care Delivery Through Visual Analytics and Sequential Rule Mining](https://arxiv.org/abs/2308.07895), pp. 1-11,
IEEE Trans. Vis. Comp. Graphics, Jan 2024 / VIS 2023. Congratulations, Carla, Andrew, and team! Carla will be presenting this work in Melbourne, Australia in October.
...
Frontiers in Oncology has accepted our paper:
A. Wentzel, A. S. R. Mohamed, M. Naser, L. V. van Dijk, K. Hutcheson, A. Moreno, C. D. Fuller, G. Canahuate, G.E. Marai,
["Multi-Organ Spatial Stratification of 3-D Dose Distributions Improves Risk Prediction of Long-Term Self-Reported Severe Symptoms in Oropharyngeal Cancer Patients Receiving Radiotherapy: Development of a Pre-Treatment Decision Support Tool"](https://www.frontiersin.org/journals/oncology/articles/10.3389/fonc.2023.1210087/full),  
...
The International Conference on Healthcare Informatics has accepted our paper: Y. Wang, L. Van Dijk, A. S. R. Mohamed, M. Naser, C. D. Fuller, X. Zhang, G. E. Marai, G. Canahuate, [Improving prediction of late symptoms using LSTM and patient-reported outcomes for head and neck cancer patients](https://dl.acm.org/doi/abs/10.1145/3472163.3472177), pp. 1-10, IEEE-ICHI The 11th IEEE International Conference on Healthcare Informatics 2023, Houston TX. Tommy (Y. Wang) will be presenting the work at the conference. Congratulations!
...
The Oral Oncology journal has accepted our paper:
G. Canahuate, A. Wentzel,  A. S. R. Mohamed, L. V. van Dijk, D. M. Vock, B. Elgohari, H. Elhalawani, C. D. Fuller, G. E. Marai, ["Spatially-aware clustering improves AJCC-8 risk stratification performance in oropharyngeal carcinomas"](https://www.sciencedirect.com/science/article/abs/pii/S1368837523001562), Oral Oncology, 2023. Congratulations, team!
...
The journal BMC Pulmonary Medicine has accepted our submission ["Alveolus Analysis: A Web Browser-based Tool to Analyze Lung
Intravital Microscopy"](https://rdcu.be/c1OCm), by A. L. Politowicz; A. T. Burks; Y. Dong; Y. M. Htwe; S. M. Dudek; G. E. Marai; P. Belvitch. So glad to see this interdisciplinary work accepted for publication. The work stems from a [CS529 VDS](http://evl.uic.edu/cs529) project with wonderful graduate students Alex Politowicz, Andrew Burks, and Yushen Dong, and the project is open source.

# Hosting sabbatical
_Nov 28, 2022_

So happy to host at UIC/EVL [Guadalupe Canahuate](https://engineering.uiowa.edu/people/guadalupe-canahuate)'s sabbatical break this term! Prof. Canahuate (University of Iowa) will present her research on "Scalable high-dimensional similarity searches using a query driven dynamic quantization" in a departmental colloquium on Nov 30th 2022.
...
Nafiul Nipu, a doctoral student in our group, is presenting our full paper
["Visual Analysis and Detection of Contrails in Aircraft Engine
Simulations"](http://arxiv.org/abs/2208.02321) at [VIS'22](http://ieeevis.org).

# Doctoral Colloquium presentation at VIS'22
_Oct 19, 2022_

Juan Trelles, a doctoral student in our group, is presenting his work
in the Doctoral Colloquium at VIS'22.


# Paper accepted in the European Journal of Cancer
_Oct 19, 2022_

Our HNC-PREDICTOR paper led by Sanne van Dijk, "Head and Neck Cancer Predictive Risk Estimator to Determine
Control and Therapeutic Outcomes of Radiotherapy (HNC-PREDICTOR)
Development, international multi-institutional validation, and
web-implementation of clinic-ready model-based risk stratification for
head and neck cancer", has been accepted by the [European Journal of
Cancer](http://www.ejcancer.com/). This paper includes a clinic-ready interactive web-interface for risk
prediction, created together with PhD student Nafiul Nipu and myself, and hosted
at EVL: [HNC-Predictor](https://uic-evl.github.io/hnc-predictor/). 

# Graduate application fee waivers in effect for Fall'2023
_Oct 16, 2022_

Thanks to an agreement between the College of
Engineering and the Office of Admissions, all applicants for
the Computer Science Graduate Program Fall'23 qualify for an application fee waiver (international students
will pay $100, and domestic students will pay $0). For instructions, please
see our department's
[graduate admissions page](http://cs.uic.edu/graduate/admissions/). Proud
to have played a small part in brokering this agreement, as the CS Director of
Graduate Admissions.

# DGA appointment
_Aug 16, 2022_

I have been officially appointed as Director of Graduate
Admissions and Co-Director of Graduate Studies, while Jakob Eriksson
is on a sabbatical leave. Big shoes to fill in.

# Promotion to full professor
_Aug 16, 2022_

I have been officially promoted to full professor. It wouldn't have
happened without the support of wonderful students and advisees, collaborators,
and colleagues in my field and at my institution.

# Paper accepted at VIS'22
_Aug 1, 2022_

Nafiul Nipu's and Carla Floricel's paper on contrail visualization has
...
I am co-chairing the Papers Program at EuroVis'22 in Rome, together with the wonderful
Rita Borgo and Tobias Schreck. We are also co-guest editing the CGF
issue correponding to the accepted papers.

# Seminar at VRVis
_May 19, 2022_

I am visiting and giving a colloquium at VRVis in Vienna about the immersive
analytics work done at EVL.
...
I am giving a colloquium at TU Wien to my lovely hosts, about
grounding data vis theory in practice.

# Paper presentation
_March 26, 2022_

Sanjana Srabanti presented our paper on healthcare disparities in head
and neck cancer at __PacificVis'22__! 
...
I am giving a seminar at NYU Tandon School of Engineering, as a
guest of Claudio Silva's group.

# Seminar at UI Cancer Center
_Dec 2, 2021_

I am giving a virtual seminar at University of Illinois Cancer Center,
where I am a member.
...
I will be on a sabbatical break Fall 2021 (NYU) and Spring 2022 (TU
Vienna). 

# Test-of-time award
_July 10, 2021_

Our paper on RuleBender has received a Test of Time Award for the
ten-years most impactful biovis paper at __ISMB'21__! So proud of my
team: Adam Smith, Wen Xu, Yao Sun and James Faeder. Miss you all.
